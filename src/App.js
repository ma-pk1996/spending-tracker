...
const FakeExpenses = [
  {id: 'e1', title: 'car rent', amount: 100, date: new Date(2021,7,13)},
  {id: 'e2', title: 'car wash', amount: 20, date: new Date(2020,7,13)},
  {id: 'e3', title: 'car repair', amount: 400, date: new Date(2022,7,13)},
  {id: 'e3', title: 'car dooni', amount: 300, date: new Date(2023,7,13)}
];
